...
# Outline
### We utilezed Jupyter Notebook and Pandas to prepare and clean our data. 
### Postgres was used to to load our database. 
### For our visualizations, we utilized Tableau.
### Once data our data was cleaned, we built the ML model. We trained and tested the dataset with multiple machine learning algorithms to find the best ML model. 
